...
export const PRICE_MONTHLY_USD = 11.99
export const PRICE_ANNUAL_USD = 107.99
...
export const PROMO_MONTHLY_USD = 7.99
export const PROMO_MONTHLY_DURATION_MONTHS = 3
export const PROMO_ANNUAL_USD = 79.99

export const LAUNCH_PROMO_END = new Date('2026-12-01T00:00:00Z')
