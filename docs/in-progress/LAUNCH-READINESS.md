...
- **Pricing model:** Freemium at $11.99/month (USD) via Lemon Squeezy (merchant of record). Free tier: manual import, research dashboard, search, 3 Hanan messages/day (basic mode only). Pro tier ($11.99/mo or $107.99/yr): unlimited Hanan + Pro (deep) mode, IBKR sync, CSV export. Full trade history available on both tiers. **Launch promo** (until 2026-12-01): monthly $7.99 for first 3 months, annual $79.99.
