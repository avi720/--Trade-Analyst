...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/ibkr-sync`,            changeFrequency: 'monthly', priority: 0.7, lastModified: now },
    { url: `${baseUrl}/fifo-analytics`,       changeFrequency: 'monthly', priority: 0.7, lastModified: now },
    { url: `${baseUrl}/ai-trading-assistant`, changeFrequency: 'monthly', priority: 0.7, lastModified: now },
